...
public class Event extends Task {
    ...
    public String report() {
        ...
        if (done) {
            return "[E]"  + "[X] " + super.getName() + " (from: " + startDate.format(formatter) + " -> to: " + endDate.format(formatter) + ")";
        }
        return "[E][ ] " + super.getName() + " (from: " + startDate.format(formatter) + " -> to: " +  endDate.format(formatter) + ")";
    }
